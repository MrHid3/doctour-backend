...
Witaj w README powalająco szybkiego, dynamicznie skalujący i modułowo dostosowanego do potrzeb każdego klienta API *doctour* (ta nazwa musi koniecznie być zmieniona kiedy dostanę klucz do API DeepL). Poniżej jest napisana na kolanie dokumentacja na niego. Nawet nie mam nadzieji że nie będzie pytań,
